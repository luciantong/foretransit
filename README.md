...
categories = [
    'Total TTC trips (2024)',
    'Bus trips',
    'Subway rides',
    'Streetcar trips',
    'Conventional bus/streetcar routes',
    'Surface routes connecting\nto subway (A.M. rush)',
    'Subway connections\n(A.M. rush)',
    'Streetcar network length'
]
...
colors = [
    '#2E86AB',  # Total trips - ridership
    '#2E86AB',  # Bus trips - ridership
    '#2E86AB',  # Subway rides - ridership
    '#2E86AB',  # Streetcar trips - ridership
    '#1B7536',  # Routes - network structure
    '#1B7536',  # Surface-subway connections - network structure
    '#1B7536',  # Subway connections - network structure
    '#D35400',  # Network length - infrastructure
]

# =============================================================================
# Figure Setup - Extra height for source note
# =============================================================================
...
# Invert y-axis so largest values appear at top
ax.invert_yaxis()
...
fig.suptitle("Why Toronto's Transit Delay Context Is Locally Specific", 
...
fig.text(0.5, 0.91, subtitle, ha='center', va='top', fontsize=9, 
...
legend_elements = [
    mpatches.Patch(facecolor='#2E86AB', edgecolor='black', linewidth=0.5, 
                   label='Ridership (millions of trips)'),
    mpatches.Patch(facecolor='#1B7536', edgecolor='black', linewidth=0.5, 
                   label='Network structure (routes/connections)'),
    mpatches.Patch(facecolor='#D35400', edgecolor='black', linewidth=0.5, 
                   label='Infrastructure (km)')
]
ax.legend(handles=legend_elements, loc='lower right', fontsize=9, framealpha=0.95)

# =============================================================================
# Source Note - Wrapped text at bottom
# =============================================================================
...
fig.text(0.5, 0.02, wrapped_source, ha='center', va='bottom', fontsize=8, 
         style='italic', color='#333333', transform=fig.transFigure,
         linespacing=1.3)
...
plt.savefig('ttc_system_overview_chart.png', dpi=300, bbox_inches='tight', 
            facecolor='white', edgecolor='none')
plt.show()

print("Chart saved as 'ttc_system_overview_chart.png'")
