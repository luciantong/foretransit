...
# Converts raw delay + gap into 1-10 score
# Used as one of three models in MAGI

def calc_delay_score(delay_seconds):
    """
    Delay Score:
      0 min delay   → 1
      7.5 min delay → 5.5
...
def calc_congestion_score(gap_seconds):
    """
...
def jayden_method(delay_seconds, gap_seconds):
    """
    Final Severity Score:
    Delay(0.7) + Congestion(0.3)
    Returns score 1-10
    """
    d = calc_delay_score(delay_seconds)
    c = calc_congestion_score(gap_seconds)
